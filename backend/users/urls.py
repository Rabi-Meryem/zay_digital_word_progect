...
urlpatterns = [
    ...
    # GET /api/users/clients/?search=xxx  (superviseur : liste des clients)
    # ⚠️ Doit être déclaré AVANT 'users/<int:pk>/' pour éviter que Django
    # essaie de matcher "clients" comme un pk.
    path('users/clients/',
